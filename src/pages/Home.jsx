...
import imgmusic from '../assets/nomusic.jpg'
...
const Home = () => {
    return (
        <Layout>
            ...
            <div className="min-h-screen flex flex-col justify-center items-center bg-music bg-fixed bg-cover bg-center bg-no-repeat">
                {/* <img src={imgmusic} alt="no music no life" className='w-full'  /> */}
                <h2 className='text-4xl text-center text-gray-400  bg-black bg-opacity-75 transition-all px-56 py-10 rounded-3xl'>Soy el <Link to='/about_me' className='hover:text-cyan-700 transition-colors cursor-pointer' >Frontend Developer</Link></h2>
            </div>
            ...
            <div className="min-h-screen flex flex-col justify-center items-center bg-stairs bg-fixed bg-cover bg-center bg-no-repeat ">
                <h2 className='text-4xl text-center text-gray-400  bg-black bg-opacity-75 transition-all px-56 py-10 rounded-3xl'>Siempre hay que <Link to='/my_works' className='hover:text-cyan-700 transition-colors cursor-pointer' >aspirar a lo mejor</Link></h2>
            </div>
            ...
            <div className="min-h-screen flex flex-col justify-center items-center bg-develop bg-fixed bg-cover bg-center bg-no-repeat ">
                <h2 className='text-4xl text-center text-gray-400  bg-black bg-opacity-75 transition-all px-56 py-10 rounded-3xl'>Tengo claro que<Link to='/contact' className='hover:text-cyan-700 transition-colors cursor-pointer' > lo voy a conseguir</Link></h2>
            </div>
        </Layout>
    )
}
