...
export const Tecnologias = () => {
    return (
        <div className='' id='tecnologias'>
            <h3 className='mb-4 px-28 text-4xl text-gray-800 dark:text-gray-400 font-semibold pt-36'>Tecnologias usadas</h3>
            <h4 className='text-3xl dark:text-gray-300 justify-start px-48 py-6'>Frontend</h4>
            <div className="flex flex-col gap-2 px-10  min-h-screen items-center" id=''>

                <div className='flex w-8/12'>

                    <p className='dark:text-gray-400 text-justify'>
                        Como frontend developer, he estado utilizando una variedad de tecnologías para crear aplicaciones y sitios web interactivos y atractivos. Estas tecnologías incluyen HTML, CSS, JavaScript, SASS, Tailwind, Material UI, ReactJS y NextJS. <br /><br />
                        ...
                        Con JavaScript hacemos que nuestras páginas sean dinámicas e interactivas. Se utiliza para agregar comportamientos a los elementos de la página, como eventos de clic, animaciones y validación de formularios.<br /><br />
                        ...
                        ReactJS es la biblioteca de JavaScript utilizada para crear interfaces de usuario dinámicas y escalables. Permite la creación de componentes reutilizables y proporciona un estado de aplicación manejado de forma eficiente para una actualización rápida y fluida de la interfaz de usuario.<br /><br />
            ...
            <h4 className='text-3xl dark:text-gray-300  justify-start px-48 py-6'>Backend</h4>
            <div className="flex flex-col gap-2 px-10  min-h-screen items-center" >
                ...
                <div className='flex w-8/12'>
                    ...
                    <p className="dark:text-gray-400 text-justify">
                        ...
                        MongoDB es una base de datos NoSQL que utiliza documentos JSON para almacenar datos. Es muy flexible y escalable, lo que la hace ideal para aplicaciones web modernas. MongoDB se integra muy bien con NodeJS y Express, lo que permite el acceso a la base de datos mediante una API RESTful.<br /><br />
