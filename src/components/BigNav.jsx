...
export const BigNav = () => {
    ...
    return (
        <nav className="hidden w-full sm:flex flex-col gap-2 sm:flex-row justify-between items-center  px-4 sticky top-0 bg-opacity-95 bg-gray-100 dark:bg-gray-800 dark:bg-opacity-80 shadow-lg">
            ...
            <Link to='hero' spy={true} smooth={true} offset={50} duration={500} className={" absolute left-8 cursor-pointer text-gray-800 hover:text-gray-600 dark:hover:text-gray-200 transition-all dark:text-gray-400"} >DM</Link>
