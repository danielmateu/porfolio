...
export const BigNav = () => {
    ...
    return (
        <nav className="hidden w-full sm:flex flex-col gap-2 sm:flex-row justify-between items-center  px-4 sticky top-0 bg-opacity-80 bg-gray-100 dark:bg-gray-800 dark:bg-opacity-75'">
            ...
            <ul className={`bg-gray-100 dark:bg-gray-800 w-full  flex flex-col items-center justify-end py-4 gap-6  sm:flex-row sm:flex`}>
                {
                    Links.map(link => (
                        <li key={link.id}>
