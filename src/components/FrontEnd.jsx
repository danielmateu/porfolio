...
export const FrontEnd = () => {
    return (
        <>
            <h3 className='mb-4 text-4xl text-gray-800 dark:text-gray-400 font-semibold'>Tecnologias usadas</h3>
            <h4 className='text-3xl dark:text-gray-300 justify-start '>Frontend</h4>
